...
<div class="wrap wrap--wide ">
    <div class="flex-block ">
        <div class="subscribe-flex-block">
            ...
            <a class="header-link-privacy"
               href="<?php the_permalink(get_page_by_path('privacy-policy')) ?>"><?php _e('Privacy Settings', 'yafrica') ?></a>
        </div>
        <div>
        <a href="<?php the_field('created_link', 'option') ?>" class="keplar" style="background-image: url(<?php echo THEME_DIR_URI ?>/assets/images/kep_quality.png);"></a>
        </div>
